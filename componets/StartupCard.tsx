...
const StartupCard = ({ post }: { post: StartupTypeCard }) => {
  ...
  return (
    <li className="bg-white text-black border-[5px] border-black py-6 px-5 rounded-[22px] shadow-200 hover:border-primary transition-all duration-500 hover:shadow-300 hover:bg-primary-100 group">
